...
// EXPANDED ANILIST TO SLUG MAPPING (800+ entries)
...
module.exports = async (req, res) => {
    ...
    try {
        const { anilistId, season, episodeNum } = req.query;
        
        if (!anilistId || !episodeNum) {
            return res.status(400).json({ 
                error: 'Missing parameters',
                message: 'anilistId and episodeNum are required'
            });
        }
        ...
        console.log(`🎌 ULTRA FETCH: ${animeSlug} - S${season || 1}E${episodeNum}`);
